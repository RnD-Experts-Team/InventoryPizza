...
$authSubject    = $devMode ? 'auth.testing.v1.>'    : 'auth.v1.>';
$hiringSubject  = $devMode ? 'hiring.testing.v1.>'  : 'hiring.v1.>';
...
return [
    ...
    'streams' => [
        [
            ...
            'durable'        => $devMode
                ? env('NATS_AUTH_DURABLE', 'INVENTORY_AUTH_TESTING_CONSUMER')
                : env('NATS_AUTH_DURABLE', 'INVENTORY_AUTH_CONSUMER'),
        ...
        [
            ...
            'durable'        => $devMode
                ? env('NATS_HIRING_DURABLE', 'INVENTORY_HIRING_TESTING_CONSUMER')
                : env('NATS_HIRING_DURABLE', 'INVENTORY_HIRING_CONSUMER'),
